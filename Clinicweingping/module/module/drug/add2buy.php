<?php
   ...
   if(empty($_POST['drug'])){
      ...
      echo "<script>alert('กรุณาเลือกยาที่ต้องการซื้อ')</script>";
      echo "<script>window.location='index.php?module=buy&action=buy_drug_manage&active=active10'</script>";
