                    ...
                    <form method="post">
                        ...
                        if (!empty($select1)) {
                            if ($select1 == 1) {
                                ...
                                $sql_selectMonthbuy = mysqli_query($conn,"Select ser_date from service");
                                ...
                                if (!empty($_GET['select2'])) {
                                    ...
                                    $sqlMonthbuy = mysqli_query($conn,"Select ser_date from service where ser_date LIKE '$_GET[select2]%'");
...
<?php if (!empty($_GET['select1']) and $_GET['select1'] == "Month" and !empty($_GET['select2']) and !empty($_GET['select3'])) {
    ...
    <div class="ibox-title">
        <h5>รายงานการบริการประจำเดือน</h5>
    ...
    <div class="ibox-content" id="divprint" align="center">
        ...
        <div class="table-responsive">
            <table style="text-align: center" align="center" >
                ...
                $sql = mysqli_query($conn,"SELECT  ser_id,ser_date,ser_total FROM service ORDER BY ser_date ASC ");
                ...
                <tr>
                    <td colspan="6" style="font-size: 15px;">รายงานการบริการ
                ...
                <?php
                $sql = "select ser_date,sum(ser_total) as 'sum'  from service group by DATE_FORMAT(ser_date, '%d %c %Y')";
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>กราฟรายการบริการประจำเดือน
                            <small>รวมการบริการแบบรายวัน</small>
                        </h5>
                    </div>
    ...
    <div class="ibox-content" id="divprint">
        ...
        <div class="table-responsive">
            <table style="text-align: center" align="center">
                ...
                $sql = mysqli_query($conn,"SELECT  ser_id,ser_date,ser_total FROM service ORDER BY t_date ASC ");
                ...
                <?php
                $sql = "select ser_date,sum(ser_total) as 'sum'  from service group by DATE_FORMAT(ser_date, '%c %Y')";
                $result = mysqli_query($conn,$sql) or die(mysql_error());
                $chart2 = "data: [";
    ...
    <div class="wrapper wrapper-content  ">
        <div class="row">
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>กราฟรายการบริการประจำปี
                            <small>รวมการบริการแบบรายเดือน</small>
                        </h5>
                    </div>
                    <div class="ibox-content">
                        <div>
    ...
    <div class="ibox-content" id="divprint">
        ...
        <div class="table-responsive">
            <table style="text-align: center" align="center">
                ...
                <?php
                $sql = "select ser_date,sum(ser_total) as 'sum'  from service group by DATE_FORMAT(ser_date, '%Y')";
                $result = mysqli_query($conn,$sql) or die(mysql_error());
                $chart2 = "data: [";
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>กราฟรายการบริการประจำปี
                            <small>รวมการบริการแบบรายปี</small>
                        </h5>
                    </div>
                    <div class="ibox-content">
                        <div>
...
<script type="text/javascript">
    ...
    function myFunction() {
        ...
        window.location.href = "index.php?module=report&action=report_service&active=active23&select1=" + x;
    ...
    function myFunction2() {
        ...
        //document.getElementById("demo").innerHTML = "You selected: " + x;
        window.location.href = "index.php?module=report&action=report_service&active=active23&select1=" + y + "&select2=" + x;
    ...
    function myFunction3() {
        ...
        //document.getElementById("demo").innerHTML = "You selected: " + x;
        window.location.href = "index.php?module=report&action=report_service&active=active23&select1=" + y + "&select2=" + x + "&select3=" + z;
    ...
    function printDiv(divName) {
        ...
        window.location.href = "index.php?module=report&action=report_service&select1=";
