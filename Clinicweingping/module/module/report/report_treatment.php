                    ...
                    <form method="post">
                        ...
                        if (!empty($select1)) {
                            if ($select1 == 1) {
                                ...
                                $sql_selectMonthbuy = mysqli_query($conn,"Select treat_date from treatment");
                                ...
                                if (!empty($_GET['select2'])) {
                                    ...
                                    $sqlMonthbuy = mysqli_query($conn,"Select treat_date from treatment where treat_date LIKE '$_GET[select2]%'");
...
<?php if (!empty($_GET['select1']) and $_GET['select1'] == "Month" and !empty($_GET['select2']) and !empty($_GET['select3'])) {
    ...
    <div class="ibox-title">
        <h5>รายงานการรักษาสัตว์ประจำเดือน</h5>
    ...
    <div class="ibox-content" id="divprint" align="center">
        ...
        <div class="table-responsive">
            <table style="text-align: center" align="center" >
                ...
                $sql = mysqli_query($conn,"SELECT  treat_id,treat_date,cash_total FROM treatment ORDER BY treat_date ASC ");
                ...
                <tr>
                    <td colspan="6" style="font-size: 15px;">รายงานการรักษาสัตว์
                ...
                <?php
                $sql = "select treat_date,sum(cash_total) as 'sum'  from treatment group by DATE_FORMAT(treat_date, '%d %c %Y')";
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>กราฟรายการการรักษาสัตว์ประจำเดือน
                            <small>รวมการรักษาสัตว์แบบรายวัน</small>
                        </h5>
                    </div>
    ...
    <div class="ibox-content" id="divprint">
        ...
        <div class="table-responsive">
            <table style="text-align: center" align="center">
                ...
                <?php
                $sql = "select treat_date,sum(cash_total) as 'sum'  from treatment group by DATE_FORMAT(treat_date, '%c %Y')";
                $result = mysqli_query($conn,$sql) or die(mysql_error());
                $chart2 = "data: [";
    ...
    <div class="wrapper wrapper-content  ">
        <div class="row">
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>กราฟรายการรักษาสัตว์ประจำปี
                            <small>รวมการรักษาสัตว์แบบรายเดือน</small>
                        </h5>
                    </div>
                    <div class="ibox-content">
                        <div>
    ...
    <div class="ibox-content" id="divprint">
        ...
        <div class="table-responsive">
            <table style="text-align: center" align="center">
                ...
                <?php
                $sql = "select treat_date,sum(cash_total) as 'sum'  from treatment group by DATE_FORMAT(treat_date, '%Y')";
                $result = mysqli_query($conn,$sql) or die(mysql_error());
                $chart2 = "data: [";
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>กราฟรายการรักษาสัตว์ประจำปี
                            <small>รวมการรักษาสัตว์แบบรายปี</small>
                        </h5>
                    </div>
                    <div class="ibox-content">
                        <div>
...
<script type="text/javascript">
    ...
    function myFunction() {
        ...
        window.location.href = "index.php?module=report&action=report_treatment&active=active22&select1=" + x;
    ...
    function myFunction2() {
        ...
        //document.getElementById("demo").innerHTML = "You selected: " + x;
        window.location.href = "index.php?module=report&action=report_treatment&active=active22&select1=" + y + "&select2=" + x;
    ...
    function myFunction3() {
        ...
        //document.getElementById("demo").innerHTML = "You selected: " + x;
        window.location.href = "index.php?module=report&action=report_treatment&active=active22&select1=" + y + "&select2=" + x + "&select3=" + z;
    ...
    function printDiv(divName) {
        ...
        window.location.href = "index.php?module=report&action=report_treatment&select1=";
